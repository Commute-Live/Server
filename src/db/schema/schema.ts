...
export type NjtMode = "rail" | "bus";

export const njtRailStations = pgTable("njt_rail_stations", {
    stopId: text("stop_id").primaryKey(),
    stopName: text("stop_name").notNull(),
    stopLat: numeric("stop_lat"),
    stopLon: numeric("stop_lon"),
...
export const njtRailRoutes = pgTable("njt_rail_routes", {
    routeId: text("route_id").primaryKey(),
    agencyId: text("agency_id"),
    routeShortName: text("route_short_name").notNull().default(""),
    routeLongName: text("route_long_name").notNull().default(""),
...
export const njtRailRouteStops = pgTable(
    "njt_rail_route_stops",
    {
        routeId: text("route_id").notNull(),
        directionId: integer("direction_id").notNull(),
        stopId: text("stop_id").notNull(),
    ...
    (table) => ({
        pk: primaryKey({
            columns: [table.routeId, table.directionId, table.stopId],
            name: "pk_njt_rail_route_stops",
        }),
    }),
);

export const njtBusStations = pgTable("njt_bus_stations", {
    stopId: text("stop_id").primaryKey(),
    stopName: text("stop_name").notNull(),
    stopLat: numeric("stop_lat"),
    stopLon: numeric("stop_lon"),
...
export const njtBusRoutes = pgTable("njt_bus_routes", {
    routeId: text("route_id").primaryKey(),
    agencyId: text("agency_id"),
    routeShortName: text("route_short_name").notNull().default(""),
    routeLongName: text("route_long_name").notNull().default(""),
...
export const njtBusRouteStops = pgTable(
    "njt_bus_route_stops",
    {
        routeId: text("route_id").notNull(),
        directionId: integer("direction_id").notNull(),
